-- ============================================================================
-- 012_seed_data.sql
-- Seed data: exchanges and default system configuration
-- ============================================================================
...
INSERT INTO config.system_parameter (param_id, param_key, param_value, param_type, category, is_readonly, description) VALUES
  ...
  (UUID(), 'identity.setup_required', 'true', 'BOOLEAN', 'IDENTITY', 0, 'Owner account must be created through secure first-run setup'),
